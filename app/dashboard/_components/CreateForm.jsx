...
const PROMPT = "on the basis of the Description,please give form in JSON format with form title,form sub-heading,form-field,form name,placeholder-name,field type , field required and form label in JSON format.";
